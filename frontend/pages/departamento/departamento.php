...
$data = new Pais();/* creamos nueva clase de config */
$allData = $data->getPais();
print_r($allData);
?>
...
<body>
  ...
  <h1 class="m-5" id="title">Departamentos</h1>
    <button type="button" class="btn btn-primary m-3" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap">Registrar nuevo departamento</button>

    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Registrar nuevo Departamento</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form id="registrarDepartamento" method="post" class="d-flex row">
              <div class="col-4">
              ...
              <div class="col-8">
                ...
                <?php
                  ...
                  ?> 
                  <option value="<?= $val['idPais']?>"><?= $val['nombrePais']?></option>
                <?php 
                endforeach; 
                ?> 
                </select>
              ...
              <div class="col-12">
                <label for="nombre" class="col-form-label">Nombre Departamento</label>
                <input 
                  type="text" 
                  class="form-control" 
                  id="nombre"
