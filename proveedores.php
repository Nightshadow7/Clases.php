...
// creamos una nueva clase de la configuracion para proveedores
                  ...
                  <table class="table table-custom ">
                    ...
                    <tbody class="" id="tabla">
                      ...
                      <tr>
                        ...
                        <td><a href="funciones/borar.php?id=<?= $val['id_proveedor'] ?>&req=deleteproveedores" class="<?= $but ?>"><i class="bi bi-trash3"></i>Borrar</a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
