...
$data = new Marca();/* creamos nueva clase de config */
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title mt-5 bg-success" id="exampleModalLabel">Nueva Marca</h5>
                        ...
                        <div class="modal-body">
                          <form class="col d-flex flex-wrap" action="../controlers/rejitro.php" method="post">
                            ...
                            <div class=" col-12 m-2">
                              <button type="submit" class="btn btn-primary" value="marca" name="guardar">Agregar marca del producto</button>
                            </div>
                  ...
                  <table class="table table-custom ">
                    ...
                    <tbody class="" id="tabla">
                      ...
                      <tr>
                        <td> <?= $val['id_marca']; ?></td>
                        <td> <?= $val['nombre']; ?></td>
                        <td><a href="../controlers/borar.php?id=<?= $val['id_marca'] ?>&req=deletemarca" class="<?= $but ?>"><i class="bi bi-trash3"></i>Borrar</a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
