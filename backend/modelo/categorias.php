                        ...
                        <div class="modal-body">
                          <form class="col d-flex flex-wrap" action="../controlers/rejitro.php" method="post">
                            ...
                            <div class=" col-12 m-2">
                              <button type="submit" class="btn btn-primary" value="categorias" name="guardar">Agregar categorias</button>
                            </div>
                  ...
                  <table class="table table-custom ">
                    <thead>
                      <tr>
                        ...
                        <th class="barra .text-light" scope="col">CATEGORIAS</th>
                    ...
                    <tbody class="" id="tabla">
                      ...
                      <tr>
                        ...
                        <td> <?= $val['nombre']; ?></td>
                        <td><a href="../controlers/borar.php?id=<?= $val['id_categoria'] ?>&req=deletecategorias" class="<?= $but ?>"><i class="bi bi-trash3"></i>Borrar</a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
